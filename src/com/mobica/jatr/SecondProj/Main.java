...
import com.mobica.jatr.FirstProj.Processing;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		*/
		...
		OrbitSatellite sputnik_mapped = (OrbitSatellite)sputnik;
		...
		sputnik_mapped.setRadioSignals(test);
		System.out.println(sputnik_mapped.getRadioSignal());
		//****
		...
		sputnik_mapped.moves(x, y, z); 
		System.out.println(sputnik_mapped.getZ());
		//*****
	}
